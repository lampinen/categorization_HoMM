...
ggplot(data=comparison_d %>%
  ...
  guides(color=guide_legend(title=NULL)) +
  theme(legend.position=c(0.4, 0.15), legend.direction="horizontal") +#, legend.box.background=element_rect(), legend.box.margin=margin(1, 6, 6, 6))
...
ggplot(data=comparison_d %>%
  ...
  geom_point(stat="summary",
             ...
             size=3,
             position=position_dodge(0.8)) +
  labs(x="Number of training meta-mappings\n(Approximate number of training concepts)", y="Proportion of runs with > 99% generalization") +
